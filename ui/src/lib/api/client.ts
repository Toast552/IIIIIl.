...
export const api = {
  ...
  launchMissionControl: () => request<MissionControlState>('/mission-control/launch', { method: 'POST' }),
  resetMissionControl: () => request<MissionControlState>('/mission-control/reset', { method: 'POST' }),
  recoverMissionControl: () => request<MissionControlState>('/mission-control/recover', { method: 'POST' }),
